...
/**
 * A PC-EFTPOS get last transaction response object.
 */
public class EFTGetLastTransactionResponse extends EFTResponse {

    /**
     * Constructs a default terminal transaction response object
     */
    EFTGetLastTransactionResponse() {
        super(EFTGetLastTransactionRequest.class);
    }
     ...
     */
    EFTTransactionRequest.TransactionType TxnType = EFTTransactionRequest.TransactionType.PurchaseCash;
    ...
    EFTTransactionRequest.TransactionType setTxnType(char c) {
     ...
     */
    Date SettlementDate = Date.from(Instant.now());
     ...
     */
    EFTTransactionRequest.AccountType CardAccountType = EFTTransactionRequest.AccountType.Default;
    ...
    /**
     * Indicates if the last transaction was successful
     */
    boolean LastTransactionSuccess = false;

    public boolean isLastTransactionSuccess() {
     ...
     * @value Type: TxnFlags
     */
    TxnFlags TxnFlags = new TxnFlags();
    ...
    /**
     * Indicates if the transaction was performed as a training mode transaction
     */
     ...
     * @value Type: Date
     */
    Date BankDate = Date.from(Instant.now());
