...
public class EFTControlPanelRequest extends EFTRequest {
    ...
    ControlPanelType CPanelType = ControlPanelType.Full;

    public ControlPanelType getCPanelType() {
        return CPanelType;
    }

    ControlPanelReturnType CPanelReturnType = ControlPanelReturnType.Immediately;

    public ControlPanelReturnType getCPanelReturnType() {
        return CPanelReturnType;
    }

    ReceiptPrintModeType ReceiptPrintMode = ReceiptPrintModeType.POSPrinter;

    public ReceiptPrintModeType getReceiptPrintMode() {
        return ReceiptPrintMode;
    }

    ReceiptCutModeType ReceiptCutMode = ReceiptCutModeType.DontCut;
